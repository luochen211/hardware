...
| 从动手开始 | 从理解开始 |
| --- | --- |
| [进入实操路线](#第一部分实操)：8 个阶段、13 个 ESP32 工程，从彩灯走到联网应用。 | [阅读硬件认知篇](docs/硬件认知篇.md)：先认识硬件整体，再进入电子系统、芯片与产品。 |
...
从一篇连续的[硬件认知篇](docs/硬件认知篇.md)开始：先看实体部件、能量与输入输出，再看联网硬件、开发板与芯片，最后理解实验验证和产品交付。文末提供专题深读入口；后续认知文档也从这篇主线接入。
